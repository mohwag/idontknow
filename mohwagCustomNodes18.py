...
class mwGridOverlay:
    ...
    def INPUT_TYPES(moh):
        return {
            "required": {
                "image": ("IMAGE",),
                "sPipe": ("MWSIZEPIPE",),
                "scndSpacing": ([32, 64, 128, 256, 512, 1024, 2048], {"default": 64}),
                "primSpacing": ([8, 16, 32, 64, 128, 256, 512], {"default": 64}),
    ...
    def mwGO(self, image, sPipe, primSpacing, scndSpacing, scndThickness, primThickMult, lineColor, transparency):
...
class mwMaskStack:
    ...
    FUNCTION = "mwMS"
    CATEGORY = "mohwag/mask"
    def mwMS(self, mask0, mask1, operation1, operation2, operation3, operation4, mask2 = None, mask3 = None, mask4 = None):
...
class mwLtntPipe_Create2: #WAS_Latent_Size_To_Number
    @classmethod
    def INPUT_TYPES(moh):
        return {"required": {
            "image": ("IMAGE", ),
...
class mwLtntPipe_VertSqueeze: #WAS_Latent_Size_To_Number
    upscale_methods = ["nearest-exact", "bilinear", "area", "bicubic", "bislerp"]
    @classmethod
    def INPUT_TYPES(moh):
        return {"required": {
