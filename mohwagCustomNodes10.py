...
class mwLtntPipe_Create: #WAS_Latent_Size_To_Number
    ...
    def INPUT_TYPES(moh):
        return {"required": {
            ...
            "initialW": ("INT", {"default": 512, "min": 64, "max": 3072, "step": 64 }),
            "initialH": ("INT", {"default": 512, "min": 64, "max": 3072, "step": 64 }),
            "outputW": ("INT", {"default": 512, "min": 64, "max": 3072, "step": 64 }),
            "outputH": ("INT", {"default": 512, "min": 64, "max": 3072, "step": 64 }),
            }}
    ...
    def mwLPC(self, ltnt, initialW, initialH, outputW, outputH):
        return ((ltnt, initialW, initialH, outputW, outputH),)
'''
...
class mwLtntPipe_CropScale: #WAS_Latent_Size_To_Number
    ...
    def INPUT_TYPES(moh):
        return {"required": {
            ...
            "outDeltaW": ("INT", {"default": 0, "min": 0, "max": 3072, "step": 16}),
            "cropTop": ("INT", {"default": 0, "min": 0, "max": 3072, "step": 8}),
            "cropBtm": ("INT", {"default": 0, "min": 0, "max": 3072, "step": 8}),
            "outDeltaH": ("INT", {"default": 0, "min": 0, "max": 3072, "step": 16}),
...
class mwCondXL:
    ...
    def INPUT_TYPES(moh):
        return {"required": {
            ...
            "compType": (moh.compositionTypes, {"default": "textConcat"}),
            "condText": ("STRING", {"multiline": True}),
            "width": ("INT", {"default": 3072, "min": 0, "max": MAX_RESOLUTION, "step":64}),
            "height": ("INT", {"default": 3072, "min": 0, "max": MAX_RESOLUTION, "step":64}),
            "crop_w": ("INT", {"default": 0, "min": 0, "max": MAX_RESOLUTION, "step":64}),
            "crop_h": ("INT", {"default": 0, "min": 0, "max": MAX_RESOLUTION, "step":64}),
            "target_width": ("INT", {"default": 3072, "min": 0, "max": MAX_RESOLUTION, "step":64}),
            "target_height": ("INT", {"default": 3072, "min": 0, "max": MAX_RESOLUTION, "step":64}),            
            }}
