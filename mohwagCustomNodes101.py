...
class mwMaskBoundingBoxRaw:  ########################################################
    ...
    RETURN_TYPES = ("MASK", "IMAGE", "MWPOSSIZEPIPE",)
    RETURN_NAMES = ("mask_pt", "image_pt","psPipe",)
    FUNCTION = "mwMBBR"
    CATEGORY = "mohwag/mask"
    def mwMBBR(self, mask_bounding_box, image_mapped, threshold, deltaLft_units, deltaRgt_units, deltaTop_units, deltaBtm_units):
        unitS = 8
        #multReq = 64
        ...
        return (maskOut, image_mapped, outputPS,)



def psPipeModForLtnt(aimgD, ad0, ad1):
...
class mwpsScale_LtntConform:
    ...
    RETURN_TYPES = ("IMAGE", "IMAGE", "MASK", "MWSIZEPIPE", "MWPOSSIZEPIPE")
    RETURN_NAMES = ("upscaled_image", "bounded_image", "bounded_mask", "sPipe", "psPipe")
    FUNCTION = "mwPSSLC"
    CATEGORY = "mohwag/scaling"
    def mwPSSLC(self, image, mask, psPipe, multOver8, nextMO8, upscale_method):
        sPipeC = mwImageTo_sPipeMethod(image)[0]
        ...
        if nextMO8 == multOver8:
            ...
            img_u = imageScaleMethod(image, upscale_method, imgWuf, imgHuf, "disabled")[0]
        ...
        return (img_u, boundedImage_u, boundedMask_u, s_ucf, ps_ucf)
