...
#pulling in funcs
from nodes import MAX_RESOLUTION, ConditioningSetArea, CheckpointLoaderSimple, ImageScale, EmptyLatentImage, ConditioningCombine, ConditioningAverage, ConditioningConcat, ConditioningSetTimestepRange, common_ksampler
...
class mwTextReplace:
    ...
    def mwTR(self, text, text1):
        findList, ReplaceList = prepString(text1)
        outText = text
